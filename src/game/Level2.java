...
public class Level2 extends GameLevel {
    ...
    public void populate(Game game) {
        ...
        door.setPosition(new Vec2(-13, 7.3f));
        door.addCollisionListener(new Pickup(this.getPlayer()));*/
